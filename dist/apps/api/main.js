...
function bootstrap() {
    return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
        ...
        app.setGlobalPrefix(environment_1.environment.server.globalPrefix);
        app.use((0, helmet_1.default)());
        app.use((0, cookie_parser_1.default)());
        app.enableCors({
            origin: environment_1.environment.server.cors.origin,
            credentials: true
        });
        yield app.listen(environment_1.environment.server.port, environment_1.environment.server.hostname);
        common_1.Logger.log(`🚀 Application is running on: http://localhost:${environment_1.environment.server.port}/${environment_1.environment.server.globalPrefix}`);
    });
}
